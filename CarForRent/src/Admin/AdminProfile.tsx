...
export default function AdminsProfile() {
 ...
 className="col-lg-8">
          <div
                     style={{width:"950px" }} 
                     className="admin-profile-card card border-0 shadow-lg overflow-hidden">
            {/* Card Header */}
              ...
              <div className="row g-0">
                ...
                <div className="col-md-8 p-4">
                  ...
                  <div className="d-flex gap-3">
                    ...
                    <Link to="/admin/AdminDashboard" className="btn btn-outline-success px-4 rounded-pill fw-bold">
